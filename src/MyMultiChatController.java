...
public class MyMultiChatController implements Runnable {
	 ...
	 * @param v
	 */
	public MyMultiChatController(MultiChatData chatData, MultiChatUI v) {
		// 로거 객체 초기화
	...
	public static void main(String[] args) {
		...
		MyMultiChatController chatController = new MyMultiChatController(chatData, v);
